<template id="register-form">
    <div class="register-wrapper">
      ...
      <form class="register-right" @submit.prevent>
        <div style="height: 100%; display: flex;flex-direction: column;justify-content: center;align-content: space-around;align-items: stretch;">
          ...
          <div class="form-group">
              ...
              <div style="display: flex; flex-direction:row">
                  <label v-if="password != '' && checkPassword!= '' && password != checkPassword" style="color: red;">Le password non corrispondono</label> 
                  <label v-else for="checkPassword">Controllo Password</label>   
              </div>
          </div>
          <div style="display:flex; flex-direction:row; justify-content: space-between;">
              ...
              <div>
                  ...
                  <RouterLink to="/login" id="Register" class="btn center-icon" >Login</RouterLink>
              </div> 
          </div>
        </div>
      </form>
  ...
  export default {
    ...
    beforeMount() {
      let init = 1000;
      setTimeout(function() {
        document.querySelector(".register-wrapper").classList.toggle("open");
        init = 300;
      }, init);
    },
    methods: {
